  ...
  return <main id="top">
    ...
    <Chapter number="01" title="INTRODUCTION" className="intro" >
      ...
      <div className="intro-grid">
        ...
        <div className="copy-stack">
          <p>I’m <strong>Arif Iskandar</strong>, a Software Engineering student at Universiti Teknikal Malaysia Melaka (UTeM), currently holding a <strong>3.47 CGPA</strong> after completing my Diploma in Computer Science at UTeM.</p>
          <p>I’m a developer and designer who enjoys building ambitious systems from idea to working product. My work spans <strong>full-stack web development, Android, AI agents, cloud systems, UI/UX, 3D environments, and interactive experiences</strong>, with a growing focus on <strong>agentic AI, multimodal systems, Vertex AI, local language models, and human-like computer interaction</strong>.</p>
          <p>A major part of my current work explores how AI can move beyond chat and actually <strong>understand goals, interact with software, use tools, observe results, recover from failures, and complete real-world tasks autonomously</strong>. I experiment with these ideas through projects such as on-device Android agents, automation platforms, and intelligent interfaces, while working across both cloud-hosted and local AI models.</p>
          <p>I’ve been building digital experiences since my teenage years, from Roblox development and freelance design to larger software and AI projects. Along the way, I became <strong>one of four Grand Prize winners nationwide in Maxis eKelas’ Misi Jelajah Digital</strong>, reached the <strong>Global Top 50 shortlist in Nothing’s Essential Lab</strong>, contributed features and UI improvements to <strong>BetterChat V4</strong>, participated in <strong>Roblox Inspire 2025</strong> and <strong>Hackathon Sedia! at MMU</strong>, and earned multiple <strong>Google Cloud</strong> credentials covering cloud infrastructure, security, machine learning and AI.</p>
          <p>My approach is simple: <strong>I learn by shipping.</strong> I turn ideas into working systems, test them against real workflows, find what breaks, iterate quickly, and keep refining until the technology feels less like a prototype and more like something people would actually want to use.</p>
    ...
    <section className="recognition" id="recognition">
      ...
      <div className="recognition-list">
        ...
        <article><span>ONGOING / ROBLOX EARLY ACCESS</span><h3>TERRAIN EARLY ACCESS TESTER</h3><p>Accepted into Roblox’s selected Terrain Early Access testing, exploring new terrain authoring features and sharing feedback as the system evolves.</p><a href="https://devforum.roblox.com/t/early-access-program-unlocking-massive-terrain-with-up-to-64-custom-materials/4703282" target="_blank" rel="noreferrer">DEVFORUM PROGRAM ↗</a></article>
        <article><span>LONG-TERM / NOTHING COMMUNITY</span><h3>NOTHING OS BETA PARTICIPANT</h3><p>Long-term Nothing OS beta program participant, testing releases from Nothing OS 3.0 through the latest Nothing OS 5.0 and feeding back on the phone experience.</p><a href="https://nothing.community/" target="_blank" rel="noreferrer">NOTHING COMMUNITY ↗</a></article>
      </div>
    </section>
    ...
    <footer><a href="#top">ARIF ISKANDAR</a><p>SOFTWARE ENGINEERING STUDENT / FULL-STACK DEVELOPER / AI AGENT BUILDER / ROBLOX SYSTEMS DESIGNER</p><p>© {new Date().getFullYear()} — MELAKA, MALAYSIA</p><a href="#top">BACK TO TOP ↑</a></footer>
  </main>
}
